                ...
                <el-form label-position="right" :model="form" ref="form" :rules="rules" label-width="160px">
                    <div class="clearfix">
                        <el-form-item label="身份证号：" prop="gmsfhm" class="left relative" style="width: 50%">
                            <el-input v-model="form.gmsfhm" @focus="inputFocus($event, 3)" placeholder="请输入身份证号"></el-input>
                        </el-form-item>
                        <el-form-item label="出入境号：" prop="cardNo" class="left" style="width: 50%">
                            <el-input v-model="form.cardNo" @focus="inputFocus($event, 3)" placeholder="请输入出入境号"></el-input>
                        </el-form-item>
                    </div>
                </el-form>
